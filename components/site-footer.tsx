      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-12">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr_0.9fr] lg:items-start">
          <div className="space-y-4">
           <Link
  href="/"
  className="group inline-flex items-center gap-3 transition duration-300 hover:-translate-y-0.5"
>
  <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-[0_10px_30px_-15px_rgba(37,99,235,0.8)] transition duration-300 group-hover:border-blue-500/40">
    <Image
      src="/logo.jpg"
      alt="Logo 2DK IT"
      width={52}
  ...
  <span className="flex flex-col leading-tight">
    ...
    <span className="text-xs text-slate-400">
      Solutions web & services informatiques
    </span>
  </span>
</Link>
        ...
        <div className="mt-8 rounded-[1.75rem] border border-white/10 bg-white/5 px-5 py-5 shadow-[0_20px_60px_rgba(0,0,0,0.18)] sm:px-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <ButtonLink className="!text-black" href="/portfolio" variant="secondary">
                Voir le portfolio
              </ButtonLink>
            </div>
          </div>
